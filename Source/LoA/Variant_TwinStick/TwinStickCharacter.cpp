...
void ATwinStickCharacter::Tick(float DeltaTime)
{
	...
	if (DashCooldownRemaining > 0.f)
		DashCooldownRemaining = FMath::Max(DashCooldownRemaining - DeltaTime, 0.f);
...
void ATwinStickCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		EnhancedInputComponent->BindAction(DashAction, ETriggerEvent::Started, this, &ATwinStickCharacter::Dash);
